...
public class Detail_Wdxzfw_chakan_Fragment3 extends Fragment{
	private View view;
	InfoFile_ infoFile_;
...
GetSWBrowsePeopleListManager getBrowsePeopleList=new GetSWBrowsePeopleListManager() {
	...
	static Detail_Wdxzfw_chakan_Fragment3 newInstance(String s) {
		Detail_Wdxzfw_chakan_Fragment3 newFragment = new Detail_Wdxzfw_chakan_Fragment3();
		return newFragment;
	}
