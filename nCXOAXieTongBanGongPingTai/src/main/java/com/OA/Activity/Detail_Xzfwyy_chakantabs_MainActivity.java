 ...
 *
 */
public class Detail_Xzfwyy_chakantabs_MainActivity extends FragmentActivity  implements OnClickListener{
	...
	private void getDatasFromInterface() {
		getFlowFormElements.getFlowFormElements(Detail_Xzfwyy_chakantabs_MainActivity.this, 1, infofile
	...
	private void InitViewPager() {
		...
		Detail_Xzfwyy_chakan_Fragment1 f1=new Detail_Xzfwyy_chakan_Fragment1().newInstance("this is first fragment");;
		Detail_Xzfwyy_chakan_Fragment2 f2=new Detail_Xzfwyy_chakan_Fragment2().newInstance("this is first fragment");;
		Detail_Xzfwyy_chakan_Fragment3 f3=new Detail_Xzfwyy_chakan_Fragment3().newInstance("this is first fragment");;
		fragmentList.add(f1);
		fragmentList.add(f2);
		fragmentList.add(f3);
		// 给ViewPager设置适配器
		...
		case R.id.btn_ckzw:
			if (hasDownZW) {
				...
				getFlowFormElements.LoadArchiveData(
						Detail_Xzfwyy_chakantabs_MainActivity.this, 2, 0,
	...
	GetFlowFormElementsManager getFlowFormElements = new GetFlowFormElementsManager() {
		...
		protected void handlerLoginInfo(Context context,
			...
			if (handleResult.getiSuccess() != null
				...
				switch (paramInt) {
				case 1:
					getBrowseUser.getBrowseUser(Detail_Xzfwyy_chakantabs_MainActivity.this, 1, WFID);
					break;
				case 2:
	...
	GetBrowsePeopleListManager getBrowseUser = new GetBrowsePeopleListManager() {
		...
		protected void handlerLoginInfo(Context context,
			...
			if (handleResult.getiSuccess() != null
				...
				switch (paramInt) {
				case 1:
					getBrowseUser.getNotBrowseUser(Detail_Xzfwyy_chakantabs_MainActivity.this, 2,WFID);
					break;
				case 2:
					getBrowseUser.getOverBrowseUser(Detail_Xzfwyy_chakantabs_MainActivity.this, 3,WFID);
					break;
				case 3:
					InitViewPager();
					break;
