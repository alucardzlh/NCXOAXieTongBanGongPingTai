...
public class Detail_Xzfwyy_chakan_Fragment2 extends Fragment{
	private View view;
	InfoFile_ infoFile_;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			view = inflater.inflate(R.layout.xzfw_xzfwyy_fragment_2, null);
			initViewAndListener();
	...
	static Detail_Xzfwyy_chakan_Fragment2 newInstance(String s) {
		Detail_Xzfwyy_chakan_Fragment2 newFragment = new Detail_Xzfwyy_chakan_Fragment2();
		return newFragment;
	}
}
