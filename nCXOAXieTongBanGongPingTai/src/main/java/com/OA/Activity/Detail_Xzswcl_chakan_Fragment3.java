...
public class Detail_Xzswcl_chakan_Fragment3 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			view = inflater.inflate(R.layout.xzsw_xzswcl_fragment_3, null);
...
GetSWBrowsePeopleListManager getBrowsePeopleList=new GetSWBrowsePeopleListManager() {
	...
	static Detail_Xzswcl_chakan_Fragment3 newInstance(String s) {
		Detail_Xzswcl_chakan_Fragment3 newFragment = new Detail_Xzswcl_chakan_Fragment3();
		return newFragment;
	}
}
