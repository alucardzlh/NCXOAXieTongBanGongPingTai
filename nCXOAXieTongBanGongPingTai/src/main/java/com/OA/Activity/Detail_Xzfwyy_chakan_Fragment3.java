...
public class Detail_Xzfwyy_chakan_Fragment3 extends Fragment{
	private View view;
	InfoFile_ infoFile_;
...
GetSWBrowsePeopleListManager getBrowsePeopleList=new GetSWBrowsePeopleListManager() {
	...
	static Detail_Xzfwyy_chakan_Fragment3 newInstance(String s) {
		Detail_Xzfwyy_chakan_Fragment3 newFragment = new Detail_Xzfwyy_chakan_Fragment3();
		return newFragment;
	}
