...
public class Detail_xzfwsh_chakan_Fragment2 extends Fragment{
	private View view;
	InfoFile_ infoFile_;
	...
	static Detail_xzfwsh_chakan_Fragment2 newInstance(String s) {
		Detail_xzfwsh_chakan_Fragment2 newFragment = new Detail_xzfwsh_chakan_Fragment2();
		return newFragment;
	}
}
