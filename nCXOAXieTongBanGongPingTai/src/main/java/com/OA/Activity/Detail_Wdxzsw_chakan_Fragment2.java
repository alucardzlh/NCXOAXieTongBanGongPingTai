...
public class Detail_Wdxzsw_chakan_Fragment2 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.xzsw_wdxzsw_fragment_2, null);
		initViewAndListener();
	...
	static Detail_Wdxzsw_chakan_Fragment2 newInstance(String s) {
		Detail_Wdxzsw_chakan_Fragment2 newFragment = new Detail_Wdxzsw_chakan_Fragment2();
		return newFragment;
	}
}
