 ...
 *
 */
public class Detail_Wdxzsw_chakantabs_MainActivity extends FragmentActivity  implements OnClickListener{
	...
	private void getDatasFromInterface() {
				getFlowFormElements.getFlowFormElements(Detail_Wdxzsw_chakantabs_MainActivity.this, 1, infofile
	...
	private void InitViewPager() {
		...
		Detail_Wdxzsw_chakan_Fragment1 f1 = new Detail_Wdxzsw_chakan_Fragment1()
				.newInstance("this is first fragment");
		Detail_Wdxzsw_chakan_Fragment2 f2 = new Detail_Wdxzsw_chakan_Fragment2()
				.newInstance("this is first fragment");
		Detail_Wdxzsw_chakan_Fragment3 f3 = new Detail_Wdxzsw_chakan_Fragment3()
				.newInstance("this is first fragment");
		fragmentList.add(f1);
		fragmentList.add(f2);
		fragmentList.add(f3);
		...
		case R.id.btn_ckzw:
			if (hasDownZW) {
				...
				getFlowFormElements.LoadArchiveData(
						Detail_Wdxzsw_chakantabs_MainActivity.this, 2, 0,
	...
	GetShouWenFormElementsManager getFlowFormElements = new GetShouWenFormElementsManager() {
		...
		protected void handlerLoginInfo(Context context,
			...
			if (handleResult.getiSuccess() != null
				...
				switch (paramInt) {
				case 1:
					getBrowseUser.getBrowseUser(Detail_Wdxzsw_chakantabs_MainActivity.this, 1, WFID);
					break;
				case 2:
	...
	GetBrowsePeopleListManager getBrowseUser = new GetBrowsePeopleListManager() {
		...
		protected void handlerLoginInfo(Context context,
			...
			if (handleResult.getiSuccess() != null
				...
				switch (paramInt) {
				case 1:
					getBrowseUser.getNotBrowseUser(Detail_Wdxzsw_chakantabs_MainActivity.this, 2,WFID);
					break;
				case 2:
					getBrowseUser.getOverBrowseUser(Detail_Wdxzsw_chakantabs_MainActivity.this, 3,WFID);
					break;
				case 3:
					InitViewPager();
					break;
