...
public class Detail_Wdxzsw_chakan_Fragment3 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			view = inflater.inflate(R.layout.xzsw_wdxzsw_fragment_3, null);
...
GetSWBrowsePeopleListManager getBrowsePeopleList=new GetSWBrowsePeopleListManager() {
	...
	static Detail_Wdxzsw_chakan_Fragment3 newInstance(String s) {
		Detail_Wdxzsw_chakan_Fragment3 newFragment = new Detail_Wdxzsw_chakan_Fragment3();
		return newFragment;
	}
}
