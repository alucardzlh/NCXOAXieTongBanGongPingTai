...
public class Detail_Xzswyy_chakan_Fragment2 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.xzsw_xzswdy_fragment_2, null);
		initViewAndListener();
	...
	static Detail_Xzswyy_chakan_Fragment2 newInstance(String s) {
		Detail_Xzswyy_chakan_Fragment2 newFragment = new Detail_Xzswyy_chakan_Fragment2();
		return newFragment;
	}
