...
public class Detail_Xzswyy_chakan_Fragment3 extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			view = inflater.inflate(R.layout.xzsw_xzswdy_fragment_3, null);
...
GetSWBrowsePeopleListManager getBrowsePeopleList=new GetSWBrowsePeopleListManager() {
	...
	static Detail_Xzswyy_chakan_Fragment3 newInstance(String s){
		Detail_Xzswyy_chakan_Fragment3 newFragment = new Detail_Xzswyy_chakan_Fragment3();
		return newFragment;
