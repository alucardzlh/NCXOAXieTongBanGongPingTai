 ...
 * 会议通知签收
 */
public abstract class SignoffManager {
	 ...
	 * @param SignCode
	 */
	public void getSignoffManager(final Context paramActivity,final int paramInt ,final int MeetingID,final String UserCode,final String  SignCode){
		...
		BaseAsyncTask loacl =new BaseAsyncTask(paramActivity,true){
			...
			protected Integer doInBackground(Integer[] paramArrayOfInteger) {
				try {
					...
					result=downloadDB("Signoff",url, MeetingID,UserCode, SignCode);
			...
			protected void onPostExecute(Integer paramInteger) {
				...
				SignoffManager.this.handlerLoginInfo(paramActivity,
