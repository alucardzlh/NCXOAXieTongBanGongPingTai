 ...
 *参加人员不参加会议操作
 */
public abstract class DropOutMtingManager {
	 ...
	 * @param paramInt
	 * @param JoinID
	 * @param JoinWorkerCode
	 * @param IsSendMsg
	 * @param UserCode
	 * @param SignCode
	 */
	public void getDropOutMtingManager(final Context paramActivity,final int paramInt ,final int JoinID,final String JoinWorkerCode,final Boolean IsSendMsg,final String UserCode,final String  SignCode){
		...
		BaseAsyncTask loacl =new BaseAsyncTask(paramActivity,true){
			...
			protected Integer doInBackground(Integer[] paramArrayOfInteger) {
				try {
					...
					result=downloadDB("DropOutMting", url, JoinID, JoinWorkerCode, IsSendMsg, UserCode, SignCode);
					Log.i(TAG, "参加人员不参加会议操作++++++++"+result);
			...
			protected void onPostExecute(Integer paramInteger) {
				...
				DropOutMtingManager.this.handlerLoginInfo(paramActivity,
