...
public class RecApply_Xzswyy_Adapter extends BaseAdapter{
	private LayoutInflater inflater;
	private Context context = null;
	List<RecApply_xzswyy_Bean> list;
	private String FlowID,WFID,Title,endTime;
	InfoFile_ infoFile_;
	public RecApply_Xzswyy_Adapter(Context context,List<RecApply_xzswyy_Bean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.xzsw_xzswyy_item, null);
