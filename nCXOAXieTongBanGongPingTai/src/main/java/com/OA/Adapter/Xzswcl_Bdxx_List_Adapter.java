...
public class Xzswcl_Bdxx_List_Adapter extends BaseAdapter{
	
	private LayoutInflater inflater;
	List<Xzswcl_Detail_Bdxx_Bean> list;
...
//	private MarqueeTextView tv_custom;
	...
	public Xzswcl_Bdxx_List_Adapter(Context context, List<Xzswcl_Detail_Bdxx_Bean> list) {
