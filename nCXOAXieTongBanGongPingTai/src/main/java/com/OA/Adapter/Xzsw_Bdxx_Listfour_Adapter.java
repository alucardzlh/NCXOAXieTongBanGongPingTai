...
public class Xzsw_Bdxx_Listfour_Adapter extends BaseAdapter{

	private LayoutInflater inflater;
//	List<Xzsw_Detail_Bdxxone_Bean> list;
	private Context context = null;
	//private List<Xzsw_Detail_Bdxxthree_Bean> list1;
	private List<Xzsw_Detail_Bdxxfour_Bean> list;
	
	
	public Xzsw_Bdxx_Listfour_Adapter(Context context, List<Xzsw_Detail_Bdxxfour_Bean> list){
